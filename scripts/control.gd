...
@onready var Property_1 = $MenuPanel/BuildingSlotsContainer/PlanetResourcesContainer/Resources/VBoxContainer/res1
@onready var Property_2 = $MenuPanel/BuildingSlotsContainer/PlanetResourcesContainer/Resources/VBoxContainer/res2
...
var available_buildings := ["Empty", "Solar Panel", "Factory", "Laboratory", "Turret"]
